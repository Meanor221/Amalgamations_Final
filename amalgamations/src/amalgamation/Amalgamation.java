...
public class Amalgamation {    
    ...
    public void setCurrentAttack(int newstat){
        this.currentAttack=newstat;
        
    }
    
    public void setCurrentDefense(int newstat){
        this.currentDefense=newstat;
        
    }
    
    public void setCurrentHealth(int newstat){
        this.currentHealth=newstat;
        
    }
    
    public void setCurrentSpeed(int newstat){
        this.currentSpeed=newstat;
